...
function Skills() {
    ...
    return (
        <section
            id="skills"
            className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/40"
        >
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
                    {Object.entries(skillGroups).map(([category, skills]) => (
                        ...
                        >
                            <h3 className="text-lg sm:text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 mb-4 sm:mb-6 text-center">
                                {category}
                            </h3>
                                ...
                                {skills.map(skill => (
                                    <div key={skill.name} className="group">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-amber-400 text-sm sm:text-base font-bold bg-amber-900/20 px-2 py-1 rounded-full border border-amber-600/30">
                                                {skill.level}%
                                            </span>
                                        </div>
                                        <div className="bg-slate-700/50 rounded-full h-2 border border-slate-600/30 overflow-hidden">
                                            <div
